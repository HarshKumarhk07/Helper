    ...
    <>
      ...
      >
        <div className="mx-auto grid w-full max-w-6xl gap-10 lg:grid-cols-[1.05fr_minmax(0,460px)] lg:gap-16 lg:items-center">
          <motion.div {...fadeUp} transition={{ duration: 0.55, ease: [0.22, 1, 0.36, 1] }} className="space-y-7 lg:space-y-9">
            ...
            <div className="space-y-6">
              ...
              <p className="max-w-lg text-lg font-medium leading-relaxed text-ink/90">
                Book vetted urban services and shop the heritage collection from one elegant account.
              </p>
            </div>
            <div className="rounded-2xl border border-ink/10 bg-sand/30 p-4 text-sm text-ink/75">
              Want to <span className="font-semibold text-ink">work</span> or{' '}
              <span className="font-semibold text-ink">sell</span> with us?{' '}
            ...
            <div className="relative">
              <div className="overflow-hidden rounded-[28px] border border-ink/10 bg-paper/95 shadow-card backdrop-blur-xl">
                <div className="px-6 pt-6 pb-1 sm:px-8 sm:pt-8">
                  <h2 className="text-[26px] font-semibold leading-tight tracking-tight text-ink">Create your account</h2>
                  <p className="mt-1 text-sm text-ink/60">A few quick details and you're in. Less than 30 seconds.</p>
                </div>
                ...
                <div className="space-y-4 px-6 pb-2 pt-5 sm:px-8">
                  ...
                  <div className="relative flex items-center gap-3 py-1">
                    ...
                    <span className="text-[10px] font-semibold uppercase tracking-[0.18em] text-ink/45">or with email</span>
                    <div className="h-px flex-1 bg-ink/10" />
                  </div>
                </div>

                <form onSubmit={onSubmit} className="space-y-4 px-6 pb-6 pt-2 sm:px-8 sm:pb-8">
                  <Field
                    label="Full name"
                    type="text"
                    value={form.name}
                  ...
                  <label className="group flex cursor-pointer select-none items-start gap-2 pt-1">
                    <span className="relative mt-0.5 inline-flex h-4 w-4 shrink-0 items-center justify-center">
                      ...
                      <svg viewBox="0 0 16 16" className="relative h-2.5 w-2.5 scale-0 stroke-paper opacity-0 transition-all duration-150 peer-checked:scale-100 peer-checked:opacity-100" fill="none" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                        <polyline points="3 8.5 6.5 12 13 4" />
                      </svg>
                    </span>
                    <span className="text-xs leading-relaxed text-ink/65 transition-colors group-hover:text-ink:text-paper">
                      I agree to the{' '}
                      <Link to="/terms" className="font-medium text-ink underline-offset-4 hover:underline">Terms</Link>{' '}
                      and{' '}
                  ...
                  <PrimaryCTA loading={submitting} label="Create account" disabled={!canSubmit} />
