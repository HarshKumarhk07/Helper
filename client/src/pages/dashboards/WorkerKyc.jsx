...
const STATUS_BANNER = {
  pending: {
    ...
    body: 'Upload your documents below to start receiving job assignments.',
  },
  submitted: {
    Icon: Hourglass,
  ...
  verified: {
    ...
    title: 'KYC verified',
    body: 'You are eligible for job assignments.',
  },
  rejected: {
    Icon: ShieldAlert,
...
export default function WorkerKyc() {
  ...
  if (loading) {
    return (
      <DashboardShell eyebrow="Worker" title="KYC verification">
