        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="md:col-span-2">
            ...
            <div className="font-mono text-black text-lg mb-6">
              At Helper, every collection blends refined silhouettes with contemporary accents, offering clothing that feels elevated, versatile, and effortlessly stylish.
            </div>
